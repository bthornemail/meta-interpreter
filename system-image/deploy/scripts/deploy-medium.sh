...
BOOTSTRAP_CONF="${ROOT_DIR}/nginx/medium/universal-life-protocol.com.bootstrap.conf"
FINAL_CONF="${ROOT_DIR}/nginx/medium/universal-life-protocol.com.conf"
LE_EMAIL="${LE_EMAIL:-}"
CERTBOT_NAMES=(
...
rsync -az --delete "${ROOT_DIR}/surfaces/" "${REMOTE}:${REMOTE_DEMO}/"
