...
BOOTSTRAP_CONF="${ROOT_DIR}/deploy/nginx/small/artifact.small.universal-life-protocol.com.bootstrap.conf"
FINAL_CONF="${ROOT_DIR}/deploy/nginx/small/artifact.small.universal-life-protocol.com.conf"
LE_EMAIL="${LE_EMAIL:-}"
