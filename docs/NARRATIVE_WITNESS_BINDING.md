...
- `demo/narrative/canonical/chapters/*.ndjson` remain the canonical narrative corpus in this repository.
- `demo/narrative/canonical/templates/character_progression_templates.json` provides canonical reusable graph shapes.
- `demo/narrative/canonical/witness_article_hooks.json` provides advisory witness hook bindings.
- `demo/narrative/derived/narrative.bound.v0.ndjson` is a derived witness artifact only.
