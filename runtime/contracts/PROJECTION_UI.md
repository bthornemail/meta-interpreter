...
- file: `surfaces/browser/projection/ttc_projection_demo.html`
...
- file: `surfaces/browser/projection/ttc_projection_stream.html`
...
- file: `surfaces/browser/projection/ttc_projection_live.html`
- role: primary live canvas surface over the same contract
- input source: SSE events from `surfaces/browser/servers/ttc_runtime_stream_server.py`
...
- file: `surfaces/browser/projection/ttc_projection_media.html`
...
- file: `surfaces/browser/projection/ttc_projection_renderer.js`
...
- file: `surfaces/browser/projection/ttc_media_adapter.js`
...
- `surfaces/browser/projection/ttc_projection_renderer.js`
...
- the static demo
- the NDJSON demo fed from `surfaces/samples/ttc_runtime_sample.ndjson`
